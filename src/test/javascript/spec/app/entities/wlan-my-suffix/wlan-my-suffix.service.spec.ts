...
describe('Service Tests', () => {
    ...
    describe('WlanMySuffix Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(WlanMySuffixService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/wlans';
                expect(this.lastConnection.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return WlanMySuffix', () => {

                let entity: WlanMySuffix;
                service.find(123).subscribe((_entity: WlanMySuffix) => {
                    entity = _entity;
                });

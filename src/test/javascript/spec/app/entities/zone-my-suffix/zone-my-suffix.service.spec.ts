...
describe('Service Tests', () => {
    ...
    describe('ZoneMySuffix Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(ZoneMySuffixService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/zones';
                expect(this.lastConnection.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return ZoneMySuffix', () => {

                let entity: ZoneMySuffix;
                service.find(123).subscribe((_entity: ZoneMySuffix) => {
                    entity = _entity;
                });

...
public class WlanGroupResource {
    ...
    @Timed
    public ResponseEntity<List<WlanGroup>> getAllWlanGroups(WlanGroupCriteria criteria) {
        log.debug("REST request to get WlanGroups by criteria: {}", criteria);
        List<WlanGroup> entityList = wlanGroupQueryService.findByCriteria(criteria);
